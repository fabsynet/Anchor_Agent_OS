...
- Add Expense navigates to /expenses placeholder page
  ...
  <done>Dashboard page replaces placeholder with real data. Summary cards show overdue tasks (red when >0), due today, renewals in 30 days, and active clients. Quick actions provide shortcuts to add client, task, policy, and expense (expense routes to placeholder).</done>
</task>
